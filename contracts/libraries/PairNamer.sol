...
// produces names for pairs of tokens using ZonuDex's naming scheme
library PairNamer {
    string private constant TOKEN_PAIR_PREFIX = 'ZXLP';
    ...
    // produces a pair symbol in the format of `ZXLP:${symbol0}:${symbol1}${suffix}`
